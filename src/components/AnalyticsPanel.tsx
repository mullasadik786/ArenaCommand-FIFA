            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={standData} margin={{ top: 10, right: 10, left: -20, bottom: 5 }}>
                <defs>
                  ...
                  <linearGradient id="colorRestrooms" x1="0" y1="0" x2="0" y2="1">
                ...
                <Tooltip
                  ...
                  labelStyle={{ color: '#1e293b', fontWeight: 'bold' }}
                />
                <Area type="monotone" dataKey="concessions" name="Food Wait (m)" stroke="#a855f7" fillOpacity={1} fill="url(#colorConcessions)" />
                <Area type="monotone" dataKey="restrooms" name="Restroom Wait (m)" stroke="#0ea5e9" fillOpacity={1} fill="url(#colorRestrooms)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
